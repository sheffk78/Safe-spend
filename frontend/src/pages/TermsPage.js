            ...
            <main className="pt-24 pb-20 px-6">
                <div className="max-w-[800px] mx-auto">
                    ...
                    <div className="bg-ss-surface p-8 md:p-12 rounded-xl border border-[rgba(255,255,255,0.06)]">
                        <h1 className="font-heading text-3xl font-bold text-ss-text mb-8">Terms of Service</h1>
                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            <p className="text-ss-text-secondary mb-6">
                                These Terms of Service will be available when Safe-Spend launches publicly. 
